...
# ==================== SPRINT 2 API TESTS (MERGED) ====================


def test_sprint2_register_success(client):
...
def test_sprint2_register_fail(client):
    res = client.post('/api/auth/register', json={
        "name": "Sarwar"
    })
...
def test_sprint2_login_success(client):
...
def test_sprint2_login_fail(client):
    res = client.post('/api/auth/login', json={
...
def test_sprint2_get_products(client):
    res = client.get('/api/products/')
    assert res.status_code == 200


def test_sprint2_create_product_unauthorized(client):
...
def test_sprint2_add_to_cart_fail(client):
...
def test_sprint2_booking_fail(client):
...
def test_summary():
    ...
    print("\n" + "=" * 60)
    print("SPRINT 1+2 API TEST CASES SUMMARY")
    print("=" * 60)
    print("Total Test Categories: 14")
    print("Total Test Cases: 43+")
    print("=" * 60)
